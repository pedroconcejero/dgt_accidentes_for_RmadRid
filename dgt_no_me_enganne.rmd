...
Busquemos, 28079 ... ¡NO EXISTE! El código postal más cercano es 28071 que es ... ORGANISMOS OFICIALES, y 28070 CÓDIGOS POSTALES. 

http://www.codigospostales.com/nestcp.cgi?28

Ponemos 00000 a NA y qué remedio 28079 a 28001 (ojo que hay muchísimos más problemas con todos los > 28055, y ay qué miedo las otras provincias)

```{r}

accid$MUNICIPIO[accid$MUNICIPIO == "00000"] <- NA
accid$MUNICIPIO[accid$MUNICIPIO == ""] <- NA

accid$MUNICIPIO[accid$MUNICIPIO == "28079"] <- "28001"

```

Veamos códs postales de accidentes con víctimas mortales

```{r}

t <- table(accid$MUNICIPIO[accid$MUERTOS > 0], 
           exclude = NULL)
